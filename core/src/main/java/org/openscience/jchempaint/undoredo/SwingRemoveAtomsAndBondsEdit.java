...
public class SwingRemoveAtomsAndBondsEdit extends RemoveAtomsAndBondsEdit implements UndoableEdit{
	...
	public SwingRemoveAtomsAndBondsEdit(IChemModel chemModel, AtomBondSet undoRedoSet, String type, IChemModelRelay chemModelRelay) {
		super(chemModel, undoRedoSet, type, chemModelRelay);
	}
