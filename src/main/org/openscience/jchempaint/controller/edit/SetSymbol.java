...
public class SetSymbol extends AbstractEdit{
     ...
     */
    public static SetSymbol setSymbol(IAtom atom, String symbol, IAtomContainer ac) {
        return new SetSymbol(atom,symbol,ac);
    }

    private SetSymbol(IAtom atom, String symbol, IAtomContainer ac) {
        this.atom = atom;
        this.symbol = symbol;
        this.ac = ac;
    }
