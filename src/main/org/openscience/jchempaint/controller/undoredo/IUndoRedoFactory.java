...
public interface IUndoRedoFactory {
	...
	public IUndoRedoable getLoadNewModelEdit(IChemModel chemModel, IAtomContainerSet oldsom, IReactionSet oldsor, IAtomContainerSet newsom, IReactionSet newsor, String type);
